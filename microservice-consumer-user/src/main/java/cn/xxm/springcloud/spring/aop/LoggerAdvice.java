package cn.xxm.springcloud.spring.aop;

import cn.xxm.springcloud.utils.DateUtil;
import cn.xxm.springcloud.utils.StringUtil;
...
public class LoggerAdvice {
    ...
    @AfterReturning("pointcut() && @annotation(loggerManage)")
